...
const LINE_BASE = { r: 76, g: 86, b: 106, a: 0.18 }; // Nord4/Polar Night line base for bright ambiance
...
export default function KineticGrid({
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      // Color Theme matching the page's current color palette (#eceff4 background, #5e81ac accent)
      const theme = {
        default: {
          bg: "#eceff4",
          lineActive: { r: 94, g: 129, b: 172, a: 0.85 }, // #5e81ac
          nodeActive: { r: 94, g: 129, b: 172, a: 1.0 },  // #5e81ac
          glow: "94,129,172",
          ripple: "94,129,172",
        },
        monochrome: {
          bg: "#eceff4",
          lineActive: { r: 46, g: 52, b: 64, a: 0.9 },   // #2e3440
          nodeActive: { r: 46, g: 52, b: 64, a: 1.0 },
          glow: "46,52,64",
          ripple: "46,52,64",
        },
      }[globalColor ?? "default"];
      ...
      ctx.fillStyle = "rgba(76,86,106,0.12)";
  ...
  return (
    <div
      className={cn(
        "relative w-full min-h-screen overflow-hidden bg-[#eceff4]",
        className,
      )}
    >
      <canvas
