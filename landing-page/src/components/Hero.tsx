...
export const Hero: React.FC = () => {
  return (
    <AnimatedSection id="hero" className="text-center relative pt-20 sm:pt-28 pb-32 min-h-[calc(100vh-5rem)] justify-center">
      ...
      {/* Main Tagline mentioning project name */}
      <motion.h1
      ...
      >
        ...
        Next-Gen Autonomous AI Infrastructure for Mission-Critical Workloads
      </motion.h1>

      {/* Subtext defining what the project is */}
      <motion.p
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        An autonomous AI cluster management platform unifying heterogeneous compute nodes, intelligent fault recovery, and real-time execution optimization into one seamless experience.
      </motion.p>
